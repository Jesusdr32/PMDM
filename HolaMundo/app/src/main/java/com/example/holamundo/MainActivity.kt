...
class MainActivity : AppCompatActivity(), AdapterView.OnItemSelectedListener, View.OnClickListener,
    ...
    val miArray = arrayOf("españa", "japon", "canada", "portugal")
    ...
    override fun onClick(v: View?) {
        ...
        /*Snackbar.make(div,"Probando Snackbar", Snackbar.LENGTH_LONG)
            .setAction("Utilizando acciones",View.OnClickListener{
                txt.text = "He pulsado el Snackbar"
            })
            .show()*/
        /*var miAlert = AlertDialog.Builder(this)

        miAlert.setTitle("DA2D1E")
        //miAlert.setMessage("Estoy practicando los mensajes de alerta")
